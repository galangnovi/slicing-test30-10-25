...
export default function SideBar(){
    ...
    return(
        <>
        <ResponsiveSidebar/>
        <aside className="hidden md:fixed md:top-0 md:left-0 md:w-[270px] md:z-20 md:h-[1080px] md:bg-white md:text-white md:flex md:flex-col md:shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
